...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.scene_feature_upscaling = UpscaleTo256Block(
            in_chans=transformer_dim,
            mid_chans=mid_chans,
            out_chans=self.upscaled_dim,
            activation=activation,
        ...
        self.mask_feature_refine = nn.Sequential(
            nn.Conv2d(self.upscaled_dim * 2, self.upscaled_dim, kernel_size=1, bias=False),
        ...
        self.mask_feature_up_512 = nn.Sequential(
            nn.ConvTranspose2d(self.upscaled_dim, 32, kernel_size=2, stride=2),
            LayerNorm2d(32),
            activation(),
    ...
    def predict_masks(
        ...
        recovered_foreground = self.foreground_proj(recovered_foreground)
